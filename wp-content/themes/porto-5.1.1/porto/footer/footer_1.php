				...
				if ( $cols ) :
					...
					switch ( $cols ) {
						...
						case 2:
							...
							break;
						case 3:
							$col_class[1] = 'col-lg-' . ( ( $porto_settings['footer-customize'] && $porto_settings['footer-widget1'] ) ? $porto_settings['footer-widget1'] : '4' );
							$col_class[2] = 'col-lg-' . ( ( $porto_settings['footer-customize'] && $porto_settings['footer-widget2'] ) ? $porto_settings['footer-widget2'] : '4' );
						...
						case 4:
							...
							$col_class[3] = 'col-lg-' . ( ( $porto_settings['footer-customize'] && $porto_settings['footer-widget3'] ) ? $porto_settings['footer-widget3'] : '3' );
							$col_class[4] = 'col-lg-' . ( ( $porto_settings['footer-customize'] && $porto_settings['footer-widget4'] ) ? $porto_settings['footer-widget4'] : '3' );
							break;
					}
					?>
					<div class="row">
