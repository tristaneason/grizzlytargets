                    ...
                    $this.infinitescroll($.extend(self.defaults, {
                        ...
                        if ('load_more' == self.defaults.paginationType) {
                            ...
                            if (infinitescroll_ins ) {
                                $(infinitescroll_ins.options.navSelector).find('.next').text($(infinitescroll_ins.options.navSelector).find('.next').data('text'));
                                if (infinitescroll_ins.options.state.currPage >= max_page) {
                                    $(infinitescroll_ins.options.navSelector).addClass('d-none');
                                }
                            }
                        }
                        var $posts = $(posts);
    ...
    $.extend($.infinitescroll.prototype, {
        _binding_load_more: function porto_load_more_binding(binding) {
            ...
            if ('unbind' === binding) {
                ...
                $(document).on('click', '.pagination.load-more .next', function(e) {
                    e.preventDefault();
