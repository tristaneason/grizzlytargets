	...
	if ( class_exists( 'Woocommerce' ) ) :
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				'selector'            => '#mini-cart',
				'container_inclusive' => true,
				'settings'            => array( 'porto_settings[minicart-type]' ),
				'render_callback'     => function() {
