	...
	class Redux_Framework_porto_settings {
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'desc'    => __( 'If yes, will be show the portfolio content in archive layout. If no, it will not show the content.', 'porto' ),
						'default' => true,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
					...
					array(
						...
						'type'     => 'switch',
						'title'    => __( 'Show Excerpt', 'porto' ),
						'desc'     => __( 'If yes, will be show the excerpt in "Medium", "Large", "Full" archive layout. If no, will show the content.', 'porto' ),
						'default'  => true,
						'on'       => __( 'Yes', 'porto' ),
						'off'      => __( 'No', 'porto' ),
				...
				array(
					...
					'fields'     => array(
						...
						array(
							...
							'type'    => 'switch',
							'title'   => __( 'Show Excerpt', 'porto' ),
							'desc'    => __( 'If yes, will show the excerpt in archive layout. If no, will be show the content.', 'porto' ),
							'default' => true,
							'on'      => __( 'Yes', 'porto' ),
							'off'     => __( 'No', 'porto' ),
						),
		...
		public function setArguments() {
			...
			if ( get_theme_mod( 'theme_options_use_new_style', false ) ) {
				...
				$customize_options_link = '<a class="porto-theme-link" href="' . esc_url( admin_url( 'customize.php' ) ) . '">Theme Options</a>';
				$new_options_link       = '';
			} else {
				$menu_title             = esc_html__( 'Theme Options', 'porto' );
				$customize_options_link = '';
				$new_options_link       = '<a href="#" class="porto-theme-link switch-live-option-panel">' . esc_html__( 'Live Option Panel', 'porto' ) . '</a>';
			}
			$this->args = array(
				'opt_name'                  => 'porto_settings',
				'display_name'              => $theme->get( 'Name' ) . ' ' . $menu_title . '<a class="porto-theme-link" href="' . esc_url( admin_url( 'admin.php?page=porto' ) ) . '">Welcome</a><a class="porto-theme-link" href="' . esc_url( admin_url( 'admin.php?page=porto' ) ) . '">Theme License</a><a class="porto-theme-link" href="' . esc_url( admin_url( 'admin.php?page=porto-changelog' ) ) . '">Change Log</a>' . $customize_options_link . '<a class="porto-theme-link" href="' . esc_url( admin_url( 'admin.php?page=porto-setup-wizard' ) ) . '">Setup Wizard</a><a class="porto-theme-link porto-theme-link-last" href="' . esc_url( admin_url( 'admin.php?page=porto-speed-optimize-wizard' ) ) . '">Speed Optimize Wizard</a>' . $new_options_link,
