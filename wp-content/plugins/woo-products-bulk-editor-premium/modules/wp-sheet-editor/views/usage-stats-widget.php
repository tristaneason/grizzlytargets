...
<div class="vg-sheet-editor-usage-stats">
	<a href="https://wpsheeteditor.com/?utm_source=wp-admin&utm_medium=usage-widget-logo" target="_blank"><img src="<?php echo VGSE()->plugin_url; ?>assets/imgs/logo-248x102.png" class="vg-logo"></a>
	<?php
