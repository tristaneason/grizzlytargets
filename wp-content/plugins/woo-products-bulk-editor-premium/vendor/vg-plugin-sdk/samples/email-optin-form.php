...
<form action="http://newsletters.apps.vegacorp.me/lists/bh871wnhpee1a/subscribe" method="post" accept-charset="utf-8" target="_blank" class="">
	<?php echo sprintf(__('<p>As a thank you for using our plugin, we want to give you access to a <b>Premium Extension for free</b>.</p>
				...
				<p>Please enter your email below and we will send you the download link for free.</p><p>We will also send you tips on how to use the spreadsheet editor to improve your SEO, increase visitors and subscribers, and <b>edit your posts extra fast</b>.</p>', vgse_wc_products()->textname), VGSE()->plugin_url . 'assets/imgs/drag-down-autofill-demo.gif'); ?>
