...
( function ( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
    ...
    const PortoHBWishlist = function ( { attributes, setAttributes, name } ) {
        const inlineStyle = {};
        if ( attributes.size ) {
        ...
        return (
            <>
                ...
                <a href="#" className={ cls } style={ inlineStyle }>
                    <i className={ attributes.icon_cl ? attributes.icon_cl : 'porto-icon-wishlist-2' }>
                    </i>
    ...
    registerBlockType( 'porto-hb/porto-wishlist', {
        title: __( 'Porto Wishlist Icon', 'porto-functionality' ),
        icon: 'porto',
        category: 'porto-hb',
        description: __(
            'Display wishlist icon in header',
            'porto-functionality'
        ),
        attributes: {
            icon_cl: {
