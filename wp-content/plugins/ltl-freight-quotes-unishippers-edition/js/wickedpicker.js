...
(function ($, window, document) {
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        showPicker: function (element) {
            ...
            // Ticket: 3975
            this.setText(element.outerHTML);
            this.showHideMeridiemControl();

            if (this.getText(element.outerHTML) !== this.getTime()) {
                ...
                var inputTime = text.split(' ');

                var newTime = {};
                if (text === '') {
                    newTime.hours = today.getHours();
                    newTime.minutes = today.getMinutes();
                    newTime.meridiem = this.parseMeridiem(today.getHours());
                    ...
                    newTime.meridiem = (meridiem === 'PM' || meridiem === 'AM') ? meridiem : 'PM';

                    if (this.options.showSeconds) {
                        newTime.seconds = inputTime[3];
                    }
                }
        ...
        formatTime: function (hour, min, meridiem, seconds) {
            ...
            if (this.options.twentyFour === false && meridiem != '') {
