...
new WPUpdatesPluginUpdater_1707( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1707') ) {
    class WPUpdatesPluginUpdater_1707 {
    	...
    	function check_for_update( $transient ) {
    		...
    		$request_args = array(
                'id' => $this->plugin_id,
                'slug' => 'myworks-qbo-sync-desktop', //$this->plugin_slug,
                'version' => $plugin_data['Version'] //$transient->checked[$this->plugin_path]
            );
