...
class QuickBooks_IPP_Service_Deposit extends QuickBooks_IPP_Service
{
	...
	{
		$xml = null;
		return parent::_findAll($Context, $realmID, QuickBooks_IPP_IDS::RESOURCE_DEPOSIT, $xml);
	}
	...
	{
		return parent::_add($Context, $realm, QuickBooks_IPP_IDS::RESOURCE_DEPOSIT, $Object);
	}
