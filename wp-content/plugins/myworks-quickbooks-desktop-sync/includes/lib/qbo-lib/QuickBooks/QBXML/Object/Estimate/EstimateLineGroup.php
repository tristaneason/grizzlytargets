 ...
 * 
 */
class QuickBooks_QBXML_Object_Estimate_EstimateLineGroup extends QuickBooks_QBXML_Object
{
	/**
	 * Create a new QuickBooks Estimate EstimateLine object
	 * 
	 * @param array $arr
	 */
	...
	public function asXML($root = null, $parent = null, $object = null)
	{
		switch ($parent)
		{
			case QUICKBOOKS_ADD_ESTIMATE:
				$root = 'EstimateLineGroupAdd';
				$parent = null;
				break;
			case QUICKBOOKS_MOD_ESTIMATE:
				$root = 'EstimateLineGroupMod';
				$parent = null;
				break;
		}
