 ...
 * 
 */
class QuickBooks_QBXML_Object_SalesOrder_SalesOrderLineGroup extends QuickBooks_QBXML_Object
{
	/**
	...
	public function asXML($root = null, $parent = null, $object = null)
	{
		switch ($parent)
		{
			case QUICKBOOKS_ADD_SALESORDER:
				$root = 'SalesOrderLineGroupAdd';
				$parent = null;
				break;
			case QUICKBOOKS_MOD_SALESORDER:
				$root = 'SalesOrderLineGroupMod';
				$parent = null;
				break;
		}
