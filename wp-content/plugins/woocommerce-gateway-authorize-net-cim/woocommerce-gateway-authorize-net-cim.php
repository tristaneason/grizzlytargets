 ...
 * Plugin URI: https://www.woocommerce.com/products/authorize-net-cim/
 * Documentation URI: https://docs.woocommerce.com/document/authorize-net-cim/
 ...
 * @since 2.10.0
 */
class WC_Authorize_Net_CIM_Loader {
	...
	/** @var WC_Authorize_Net_CIM_Loader single instance of this class */
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot clone instances of %s.', get_class( $this ) ), '2.10.0' );
	}
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ), '2.10.0' );
	}
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-authorize-net-cim.php' );
	...
	/**
	 * Displays any admin notices added with \WC_Authorize_Net_CIM_Loader::add_admin_notice()
	 *
	 * @since 2.10.0
	 */
	...
	/**
	 * Gets the main \WC_Authorize_Net_CIM_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 2.10.0
	 *
	 * @return \WC_Authorize_Net_CIM_Loader
	 */
...
// fire it up!
WC_Authorize_Net_CIM_Loader::instance();
